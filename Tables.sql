...
CREATE TABLE Fare (
  RouteID NUMBER(10),
  StationID NUMBER(10),
  FarePrice NUMBER(6,2),
  PRIMARY KEY (RouteID, StationID),
  CONSTRAINT fk_Fare_Routes FOREIGN KEY (RouteID) REFERENCES Routes(RouteID) ON DELETE CASCADE,
  CONSTRAINT fk_Fare_Stations FOREIGN KEY (StationID) REFERENCES Stations(StationID) ON DELETE CASCADE
);
